...
class CapitalQuiz:
    ...
    def __init__(self, how_many):
        ...
        self.round_heading = Label(self.country_frame, text=f"What is the Capital of #", bg="#FFE1C6",
                                   font=("Arial", "15", "bold"))
        ...
        self.button_capital_list = []

        # create four button in a 1 x 4 grid
        for item in range(0, 4):
            self.capital_button = Button(self.button_frame, font=("Arial", "12"),
    ...
    def new_round(self):
        ...
        self.round_heading.config(text= f"What is the Capital of {self.country}")
        ...
        for count, item in enumerate(self.capital_button_ref):
            item.config(text=self.round_countries[count][1], state=NORMAL)
    ...
    def round_results(self, user_choice):
        ...
        capital name and checks if correct
        """
        ...
        user_choice = self.capital_button_ref[user_choice].cget('text')

        round_capital = self.round_country[1]

        # If chosen country name is correct, congratulates user
        if user_choice == round_capital:
            result_text = f"Amazing! {round_capital} is correct"
            result_bg = "#82B366"
        ...
        # Else displays correct answer
            ...
            result_text = f"Oops, it was {round_capital}"
            result_bg = "#F8CECC"
